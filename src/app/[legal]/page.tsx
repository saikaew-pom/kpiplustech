...
const pages = {
  privacy: {
    title: "Privacy",
    intro: "How NAVA intends to handle information submitted through this website.",
    sections: [
      ...
      ["Contact", "This is a launch placeholder and requires legal review before production. Contact support@thekpiplus.com with privacy questions."],
    ],
  },
  terms: {
    title: "Terms",
    intro: "Basic terms for using the NAVA website.",
    sections: [
      ...
      ["Intellectual property", "Unless stated otherwise, the website's brand, design, written content, and original materials belong to NAVA."],
  ...
  accessibility: {
    title: "Accessibility",
    intro: "NAVA aims to make its website useful to as many people as possible.",
    sections: [
      ...
      ["Feedback", "If something prevents you from using this website, contact support@thekpiplus.com and describe the page, device, and assistance you need."],
    ],
  },
} as const;
  ...
  return (
    <main id="main-content" className="legal-page">
      <article className="reading-shell">
        <span className="section-kicker">NAVA</span>
        <h1>{page.title}</h1>
